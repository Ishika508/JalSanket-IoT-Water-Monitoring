        ...
        {isProcessing ? (
          ...
          <div className="premium-panel p-8 md:p-10 space-y-8 ticket-anim border-t-4 border-t-cyan-500">
            ...
            <div className="space-y-2">
              ...
              <select className="w-full bg-[#0f172a] border border-white/10 rounded-2xl py-4 px-5 text-white focus:border-rose-500 outline-none appearance-none cursor-pointer">
